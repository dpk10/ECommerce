  ...
  return (
    <div>
      ...
      <div className="container mx-auto px-4 flex justify-between items-center h-16">
        ...
        <button className='text-gray-300 hover:text-white px-3 py-2 rounded-md text-sm font-medium' type='button' onClick={handleLogout}>Logout</button>
        {/* <NavLink onClick={handleLogout} className='text-gray-300 hover:text-white px-3 py-2 rounded-md text-sm font-medium'> <Link to="/register">Logout</Link></NavLink> */}
